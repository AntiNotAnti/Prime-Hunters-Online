    ...
    public static partial class NetSession
    {
        ...
        private static void ApplyPostMatchReport(PostMatchReportPacket report)
        {
            ...
            for (int i = 0; i < _postMatchReportCount; i++)
            {
                ...
                // The server is the scorer. Re-apply all report-facing totals
                // for every player so a lost final snapshot cannot leave one
                // row stale while the rest of the report is authoritative.
