...
public sealed class MapBuildSnapshot
{
    ...
    private MapBuildSnapshot(MapDefinition definition) => _definition = MapProjectSerializer.Clone(definition);
    ...
    public MapDefinition CreateDefinition() => MapProjectSerializer.Clone(_definition);
}
