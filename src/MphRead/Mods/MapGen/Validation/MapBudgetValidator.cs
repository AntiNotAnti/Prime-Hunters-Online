...
namespace MphRead.Mods.MapGen
{
    public static class MapBudgetValidator
    {
        ...
        /// <summary>
        /// Whether collision can be represented by the MPH wc01 format. Used
        /// by the Q3 importer before publishing patch collision so oversized
        /// source maps can reduce patch detail instead of compiling a room the
        /// packer can never encode.
        /// </summary>
