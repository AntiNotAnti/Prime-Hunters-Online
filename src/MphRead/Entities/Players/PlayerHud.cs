...
namespace MphRead.Entities
{
    public partial class PlayerEntity
    {
        ...
        public void DrawHudObjects()
        {
            ...
            ModDrawEndScreen();
            // The final camera gets to stay cinematic. The actual ten-second
            // results phase is where the full report lives, and drawing it
            // before spectator/menu early-outs makes it available to everyone.
            ...
            {
                // ModDrawPostMatchReport already drew the authoritative report
                // above, before spectator/menu early-outs.
            }
